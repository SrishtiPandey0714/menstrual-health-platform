      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <section className="prose prose-pink max-w-none">
          <p className="text-gray-700">
            Welcome to CycleCare. By accessing or using our services, you agree to be bound by these Terms of Service.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            By accessing or using the CycleCare platform, you agree to be bound by these Terms of Service and our Privacy Policy.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            CycleCare provides an AI-powered platform for menstrual health tracking and education. Our services include cycle tracking, educational content, and AI-powered insights.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            All content and materials available on our platform, including but not limited to text, graphics, logos, and software, are the property of CycleCare or its licensors.
          </p>
        </section>
        ...
        <section className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700">
                To the maximum extent permitted by law, CycleCare shall not be liable for any indirect, incidental, or consequential damages resulting from your use of our services.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                These terms shall be governed by and construed in accordance with the laws of the jurisdiction in which CycleCare operates.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:legal@cyclecare.com" className="text-pink-600 hover:text-pink-500 font-medium">
                  legal@cyclecare.com
                </a>.
              </p>
            </div>
