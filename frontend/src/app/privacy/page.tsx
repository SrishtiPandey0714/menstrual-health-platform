      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <section className="prose prose-pink max-w-none">
          <p className="text-gray-700">
            At Luniva, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services.
          </p>
        </section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:privacy@luniva.com" className="text-pink-600 hover:text-pink-500 font-medium">
                  privacy@luniva.com
                </a>.
              </p>
            </div>
