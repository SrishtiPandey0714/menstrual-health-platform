      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <section className="prose prose-pink max-w-none">
          <p className="text-gray-700">
            At Luniva, we believe menstrual health is a fundamental part of overall well-being — not a taboo. Yet for millions of people, access to accurate information, personalized guidance, and supportive resources remains limited. Our mission is to change that.
          </p>
          <p className="text-gray-700">
            Luniva is a thoughtfully designed digital platform that helps individuals understand, track, and manage their menstrual health with confidence. By combining evidence-based health knowledge with inclusive design and optional AI-powered support, we aim to create a safe, respectful, and empowering experience for everyone who menstruates.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 mb-6">
            Menstrual health is deeply personal, and every body is different. Luniva was built to:
          </p>
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4">
            Luniva offers both non-AI and AI-powered features. While core functionalities like cycle tracking, reminders, and educational resources are available to all users, AI-based assistance is entirely optional and consent-driven.
          </p>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-700">
                Luniva is designed for all people who menstruate, regardless of gender identity, background, or life stage.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
        ...
        <section className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <p className="text-gray-700 mb-4">
            We envision a future where menstrual health is openly discussed, well understood, and supported by compassionate technology. Luniva strives to be more than an app — we aim to be a trusted companion in every user's health journey.
          </p>
          <p className="text-gray-700">
